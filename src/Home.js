    ...
    <div className="home">
      ...
      <div className="home__section">
        <Card
          ...
          description="Unique activities we can together , led by a world of hosts"
        />
        <Card
      ...
      <div className="home__section">
        ...
        <Card
          ...
          description="Superhost with green amenities and a fablous shopping complex nearby"
          price="$250/night"
        />
      </div>
    </div>
